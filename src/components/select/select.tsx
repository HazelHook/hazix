import { component$, createContextId, useSignal } from "@builder.io/qwik"
...
const selectContext = createContextId(SELECT_NAME)
...
const Select = component$<SelectProps>((props) => {
	...
	const triggerSignal = useSignal<SelectTriggerElement | null>(null)
	const valueNodeSignal = useSignal<SelectValueElement | null>(null)
	const valueNodeHasChildrenSignal = useSignal(false)
