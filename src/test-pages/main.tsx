...
export const MainPage = component$(() => {
	...
	return (
		<div class="space-y-12 py-48">
			...
			<Dialog.Root>
				<Dialog.Trigger class="text-violet11 shadow-blackA7 hover:bg-mauve3 inline-flex h-[35px] items-center justify-center rounded-[4px] bg-white px-[15px] font-medium leading-none shadow-[0_2px_10px] focus:shadow-[0_0_0_2px] focus:shadow-black focus:outline-none">
					Dialog
				</Dialog.Trigger>
				<Dialog.Portal>
			...
			<Select.Root>
				...
				<Select.Content class="overflow-hidden bg-white rounded-md shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)]">
					...
					<Select.Viewport class="p-[5px]">
						<Select.Group>
							<Select.Label class="px-[25px] text-xs leading-[25px] text-mauve11">Fruits</Select.Label>
